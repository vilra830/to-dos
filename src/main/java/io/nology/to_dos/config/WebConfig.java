...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(@SuppressWarnings("null") CorsRegistry registry) { // we can define what incoming request can do , ie.this path is allowed, this path is denied - it could be null hence the warning
    String[] allowedOrigins = { "http://localhost:5173/", "http://127.0.0.1:5173/" };
        // these are the locations origins that I am letting make a request to this backend
